...
const top16ResultsData: { [key: string]: Top16GameData } = {
    arcaea: {
        ...
        songInfo: [
            {
                image: '/src/img/arcaea/01.jpeg',
                title: 'ENERGY SYNERGY MATRIX',
                artist: 'Tanchiky',
                diff: 'BYD 10',
            },
            {
                image: '/src/img/arcaea/02.jpeg',
                title: 'Dantalion',
                artist: 'Team Grimoire',
                diff: 'FTR 10+',
            },
            {
                image: '/src/img/arcaea/03.jpeg',
                title: 'Callima Karma',
    ...
    maimai: {
        ...
        songInfo: [
            {
                image: '/src/img/maimai/01.jpeg',
                title: '前衛的Landscape',
                artist: 'HiTECH NINJA feat. RANASOL',
                diff: 'MAS 13+',
            },
            {
                image: '/src/img/maimai/02.jpeg',
                title: 'FFT',
                artist: 'cybermiso',
                diff: 'MAS 14',
            },
            {
                image: '/src/img/maimai/03.jpeg',
                title: '天火明命',
                artist: '削除',
                diff: 'MAS 14',
            },
    ...
    chunithm: {
        ...
        songInfo: [
            {
                image: '/src/img/chunithm/01.jpeg',
                title: 'Calamity Fortune',
                artist: 'LeaF',
                diff: 'MAS 14+',
            },
            {
                image: '/src/img/chunithm/02.jpeg',
                title: 'Superbia',
                artist: 'Team Grimoire',
                diff: 'MAS 14+',
            },
            {
                image: '/src/img/chunithm/03.jpeg',
                title: '蜘蛛の糸',
        ...
        players: [
            {rank: 1, player: "halcybody", score: [null, null, null]},
            {rank: 2, player: "thaumaturxy", score: [null, null, null]},
            {rank: 3, player: "sean6095", score: [null, null, null]},
            {rank: 4, player: "ric3cat", score: [null, null, null]},
            {rank: 5, player: "xv16_tensixho", score: [null, null, null]},
            {rank: 6, player: "thomas86llk", score: [null, null, null]},
            {rank: 7, player: "meikungloveayame", score: [null, null, null]},
            {rank: 8, player: "magnet_.", score: [null, null, null]},
    ...
    'ProjectSakai-jp': {
        ...
        songInfo: [
            {
                image: '/src/img/pjskjp/01.jpeg',
                title: 'SAN値直葬',
                artist: 'STEAKA.',
                diff: 'MAS 33',
            },
            {
                image: '/src/img/pjskjp/02.jpeg',
                title: '0.0000034',
                artist: 'Musanuriyu.',
                diff: 'MAS 34',
            },
            {
                image: '/src/img/pjskjp/03.jpeg',
                title: 'folern',
                artist: 'nulut.',
                diff: 'APD 35',
            },
            {
                image: '/src/img/pjskjp/04.jpeg',
                title: 'the EmpErroR',
                artist: 'sasakure.UK',
                diff: 'MAS 36',
            },
    ...
    'ProjectSakai-in': {
        ...
        songInfo: [
            {
                image: '/src/img/pjskin/01.jpeg',
                title: 'ピノキオピー - ノンブレス・オブリージュ',
                artist: 'Pinocchio-P',
                diff: 'MAS 31',
            },
            {
                image: '/src/img/pjskin/02.jpeg',
                title: '異常熱',
                artist: 'iyowa covered by 25-ji, Nightcord de.',
                diff: 'MAS 32',
            },
            {
                image: '/src/img/pjskin/03.jpeg',
                title: 'folern',
                artist: 'nulut.',
                diff: 'MAS 32',
            },
            {
                image: '/src/img/pjskin/04.jpeg',
                title: 'トンデモワンダーズ',
                artist: 'sasakure.UK',
                diff: 'APD 33',
            },
            {
                image: '/src/img/pjskin/05.jpeg',
                title: '孃王',
                artist: 'HachiojiP',
                diff: 'MAS 33',
            },
