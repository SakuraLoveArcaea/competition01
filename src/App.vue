...
const announcementData = ref([
    { project: 'Arcaea', prelims: true, top16: true, top8_list: false },
    { project: 'maimai', prelims: true, top16: true, top8_list: false },
    { project: 'Chunithm', prelims: true, top16: true, top8_list: false },
    { project: 'PJSK 日服', prelims: false, top16: false, top8_list: false },
    { project: 'PJSK 國際/台服', prelims: false, top16: true, top8_list: false },
]);
// --- End of Data ---
  ...
  <div class="app-wrapper">
    ...
    <div class="announcement-section">
      <div class="announcement-toggle">
        <Checkbox v-model="showAnnouncement" inputId="announcementToggle" :binary="true" />
        <label for="announcementToggle" class="ml-2">顯示公告</label>
      </div>
      <div v-if="showAnnouncement" class="announcement-table">
        <h3>各項目成績公布狀態</h3>
        <DataTable :value="announcementData" size="small" stripedRows>
          <Column field="project" header="項目"></Column>
          <Column header="預選賽">
            <template #body="slotProps">
              <Tag :severity="getStatusSeverity(slotProps.data.prelims)" :value="slotProps.data.prelims ? '已公布' : '未公布'"></Tag>
            </template>
          </Column>
          <Column header="十六強名單">
            <template #body="slotProps">
              <Tag :severity="getStatusSeverity(slotProps.data.top16)" :value="slotProps.data.top16 ? '已公布' : '未公布'"></Tag>
            </template>
          </Column>
          <Column header="八強名單">
            <template #body="slotProps">
              <Tag :severity="getStatusSeverity(slotProps.data.top8_list)" :value="slotProps.data.top8_list ? '已公布' : '未公布'"></Tag>
            </template>
          </Column>
        </DataTable>
      </div>
    ...
    <footer class="app-footer">
      <p>如有問題請找 Discord: sakuralovearcaea</p>
    </footer>
  </div>
</template>
